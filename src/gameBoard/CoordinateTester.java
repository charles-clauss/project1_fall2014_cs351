...
public class CoordinateTester
{
  ...
  public void testPathfinder(){
    ...
    Coordinate start = new Coordinate(2000, 2000);
    Coordinate goal = new Coordinate(2002, 2002);
 ...
 //     System.out.println("Neighbors X,Y: " + c.getX() + "," + c.getY() +", weight = " + c.getWeight() );
 ...
 //   }
   ...
   // printStuff(goal);
    ...
    for (Coordinate c : myPath){
      System.out.println("Path is: " + c.getX() + "," + c.getY() );
    }
